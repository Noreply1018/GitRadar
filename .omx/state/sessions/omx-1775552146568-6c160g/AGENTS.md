...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775552146568-6c160g | 2026-04-07T08:55:47.513Z

**Codebase Map:**
  src/commands/: analyze-digest, generate-daily-digest, list-feedback, process-writeback-request, send-wecom-sample, validate-digest-rules, write-environment-report, write-github-runtime
  src/config/: digest-rules, env, mask, user-preferences
  src/core/: archive, date, digest, environment-report, failure-report, github-execution-state, log
  src/digest/: generate, model, rules
  src/feedback/: insights, model, store
  src/github/: candidates, client, platform-client, trending, types
  src/notifiers/: notifier, wecom-robot
  src/utils/: async
  src/web-api/: server, archive-service, digest-rules-service, environment-fingerprint-service, github-runtime-service, repo-sync-service, schedule-service, user-preferences-service, api
  tests/: analyze-digest.test, digest-model.test, digest-rules.test, env-config.test, generate-digest.test, github-trending.test, list-feedback.test, validate-digest-rules-command.test, web-api-services.test, wecom-robot.test
  web/: App, api, main, vite.config
